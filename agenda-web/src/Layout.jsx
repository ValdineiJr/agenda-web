  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className={
        ...
        ${menuAberto ? 'md:w-72' : 'md:w-0'} /* Desktop Toggle */
        `
      }>
        ...
        <div className="w-72 flex flex-col h-full">
          ...
          <div className="flex flex-col items-center justify-center pt-8 pb-6 px-4 border-b border-white/10 bg-black/10">
            ...
            <h1 className="text-xl font-bold tracking-wide">Agenda Salão</h1>
            <p className="text-xs text-fuchsia-200 uppercase tracking-widest mt-1 opacity-70">
          ...
          <nav className="flex-1 p-4 space-y-2 overflow-y-auto custom-scrollbar">
            ...
            {session ? (
              <>
                <div className="pt-4 pb-2 px-4 text-xs font-bold text-fuchsia-300/60 uppercase tracking-wider">
                  Minha Área
                </div>
          ...
          {session && (
            <div className="p-4 bg-black/20 border-t border-white/10">
               <button 
                 ...
                 className="w-full flex items-center justify-center gap-2 bg-red-600/80 hover:bg-red-600 text-white py-2 rounded-lg text-xs font-bold shadow-md transition-all hover:scale-105"
